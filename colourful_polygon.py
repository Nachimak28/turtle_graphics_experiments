...
for i in range(2, 100):
    ...
    ts.getcanvas().postscript(file=f"coloured_polygon_{iterations}_iterations_number_of_sides_{number_of_sides_of_polygon}.eps", pagewidth=720, pageheight=1280)
    screen.resetscreen()
turtle.done()
# exit screen
# turtle.resetscreen()
